...
<ul><li>Are pregnant.</li>
<li>Live in Washington State.</li>
<li>Have income at or below 193% of the Federal Poverty Level (FPL)&nbsp;(see income chart below).*</li>
</ul><h3>What is the most I can make per month to qualify?</h3>
<div class="table-responsive">
<table class="table-striped" summary="Table outlining the income standards for Apple Health for Pregnant Individuals"><thead><tr><th>
<p>Program**</p>
</th>
<th>
<p>Single<br>
...
** Household includes the unborn child. For example, a single individual expecting one child is a 2-person household.</p>
...
<h2><a id="after-pregnancy-coverage" name="after-pregnancy-coverage"></a>After-Pregnancy Coverage</h2>
...
<h2><a id="confidential-services" name="confidential-services"></a>Confidential services</h2>
...
<h2><a id="applying-for-apple-health-coverage" name="applying-for-apple-health-coverage"></a>Applying for Apple Health coverage</h2>
...
<ul><li>Your household monthly income.</li>
...
</ul><h2><a id="enrollment-next-steps" name="enrollment-next-steps"></a>Enrollment next steps</h2>
...
<div class="notebox">
<p>If you're not eligible for Apple Health, you may qualify for help with your health insurance or for other health services. Visit&nbsp;<a href="https://www.wahealthplanfinder.org/" class="ext" data-extlink="" target="_blank" rel="noopener noreferrer">Washington Healthplanfinder<span class="fa-ext extlink"><span class="fa-solid fa-up-right-from-square" aria-label="(link is external)"></span></span></a>&nbsp;or use the&nbsp;<a href="https://www.wahbexchange.org/mobile/" class="ext" data-extlink="" target="_blank" rel="noopener noreferrer">WAPlanfinder app<span class="fa-ext extlink"><span class="fa-solid fa-up-right-from-square" aria-label="(link is external)"></span></span></a>&nbsp;to learn if you qualify.</p>
</div>
</div>
